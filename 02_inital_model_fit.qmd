---
title: "Initial Model Fit and Deployment"
format: html
---
...
Next, we create a board using the `board_connect()` function; a board is simply a connection to our Connect server. And then we pin the model with the `vetiver_pin_write()` function.
```{r}
...
vetiver_deploy_rsconnect(
  board = model_board,
  name = "pritam.dalal/student_loan_model_r",
  launch.browser = FALSE,
  appTitle = "Student Loan Model - API - R",
